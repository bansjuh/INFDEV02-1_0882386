...
playerChoice = input(" Choose between Rock, Paper, Scissors, Lizard or Spock \n ").lower() # if caps are used it wil convert it to lower characters.
...
while (playerChoice != "rock" and playerChoice != "paper" and playerChoice != "scissors"  and playerChoice != "lizard"  and playerChoice != "spock" ):#
    playerChoice = input("I thought we played a game of Rock, Paper, Scissors, Lizard or Spock: ")
if playerChoice == ("rock"):
    if computerChoice == (1):
        ...
        print (" To bad, the opponents Spock vaporized your Rock. You Loose. ")
if playerChoice == ("paper"):
    if computerChoice == (1):
        ...
        print (" To bad, the opponents Lizard eats your Paper! You Loose. ")
    elif computerChoice == (5):
...
if playerChoice == ("scissors"):
    if computerChoice == (1):
        ...
        print (" To bad, the opponents Spock Smashed your Scissors! You Loose. ")
if playerChoice == ("lizard"):
    if computerChoice == (1):
        print (" To bad, the opponents Rock crushed your Lizard! You Loose. ")
    elif computerChoice == (2):
        print (" Well done, your Lizard eats the opponents Paper! You Win. ")
    elif computerChoice == (3):
        print (" To bad, your Lizard got decapetated by the opponents Scissors! You Loose. ")
    elif computerChoice == (4):
...
if playerChoice == ("spock"):
    if computerChoice == (1):
        ...
        print (" To bad, your Spock got disproved by the opponents Paper! You Loose. ")
    elif computerChoice == (3):
        print (" Well done, your Spock Smashed the opponents Scissors! You Win. ")
    elif computerChoice == (4):
        print (" To bad, your Spock got posioned by the opponents Lizard! You Loose. ")
    elif computerChoice == (5):
